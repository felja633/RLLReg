...
def configure_datasets():
    ...
    return threedmatch.ThreeDMatchDataset(dset_path=path_threedmatch, parameters=threedmatch_params, downsampler=downsampler,
                                          preprocessor=processor, training=True, correspondence_rate=0.0)
...
def configure_trainer(model):
    ...
    base_vs_weight = 18*(40.0 - 24.0)/2.0
