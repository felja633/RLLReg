# code adapted from https://github.com/chrischoy/FCGF

import torch
import MinkowskiEngine as ME
import MinkowskiEngine.MinkowskiFunctional as MEF
from models.feature_extraction.fcgf.common import get_norm

from models.feature_extraction.fcgf.residual_block import get_block
...
class ResUNet2(ME.MinkowskiNetwork):
  ...
  def forward(self, x):
    ...
    out_att = ME.SparseTensor(self.final_att_act(out_att.F), coords_key=out_att.coords_key, coords_manager=out_att.coords_man)
